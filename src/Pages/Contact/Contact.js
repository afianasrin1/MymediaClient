...
const Contact = () => {
    return (
        <section className='mt-5 lg:mt-16'>
                        ...
                        <div className="py-6 md:py-0 md:px-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="flex items-center">
                                    ...
                                    <a href="tel:+880-1674-931378" className='hover:text-primary transition-all'>    <span>+880-1674-931378</span></a>
                                </p>
                                <p className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                    ...
                                    <a
                                        href="mailto:afia.nasrin3e@gmail.com"
                                        aria-label="Our email"
                                        title="Our email"
                                        className="hover:text-primary transition-all duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
                                    >
                                        afia.nasrin3e@gmail.com
                                    </a>
                                </p>
                            </div>
                        </div>
            ...
            <div>
                <iframe className='w-full md:h-[550px] sm:h-[500px] h-[350px]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28891.706669584622!2d89.74312203856074!3d25.153828470632355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fd6c2a62e1635d%3A0xf8f39d1030c228d6!2sDewanganj!5e0!3m2!1sen!2sbd!4v1672115092562!5m2!1sen!2sbd" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </section>
    );
};
