                                            ...
                                            <div className=''>
                                                ...
                                                <div className="input_field flex flex-col w-max mx-auto text-center">
                                                    <label htmlFor='uploadImage'>
                                                        ...
                                                        <div className="text bg-indigo-600 text-white border border-primary rounded font-semibold cursor-pointer p-1 px-3 hover:bg-indigo-500">Upload Image</div>
                                                    </label>

                                                    <div className="title text-indigo-500 uppercase">Image is required</div>
                                                </div>
                                            </div>
                                    }
